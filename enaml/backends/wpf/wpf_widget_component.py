...
class WPFWidgetComponent(WPFBaseWidgetComponent, AbstractTkWidgetComponent):
    ...
    def size_hint(self):
        ...
        """
        self.widget.Measure((self.widget.MaxWidth, self.widget.MaxHeight))
        print "Widget {} wants to be {}".format(self.widget,
                                                self.widget.DesiredSize)
        return Size(*self.widget.DesiredSize)
    ...
    def set_min_size(self, size):
        ...
        """
        print "Set MinSize of {} to {}".format(self.widget, size)
        self.widget.MinWidth, self.widget.MinHeight = size
    ...
    def set_max_size(self, size):
        ...
        """
        print "Set MaxSize of {} to {}".format(self.widget, size)
        self.widget.MaxWidth, self.widget.MaxHeight = size
    ...
    def resize(self, size):
        ...
        print "The new size of the {} widget is {}".format(widget, size)
